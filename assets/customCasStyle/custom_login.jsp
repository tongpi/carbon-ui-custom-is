...
%>
    ...
    <header class="header header-default">
        <div class="container-fluid header-default-top">
            <div class="pull-left brand float-remove-xs text-center-xs">
                <a href="#">
<!--                    <img src="images/logo-inverse.svg" alt="wso2" title="wso2" class="logo">

                    <h1><em><%=AuthenticationEndpointUtil.i18n(resourceBundle, "identity.server")%></em></h1>-->
					<img src="images/login_logo.png" alt="wso2" title="wso2" class="logo">
                </a>
            </div>
        </div>
    </header>
    ...
    <!-- page content -->
    <div class="container-fluid body-wrapper body-wrapper-height">
            ...
            <div class="col-md-12">
                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-4 col-centered wr-content wr-login col-centered">
                    <div class="cont_title_box">
                        <h2 class="wr-title uppercase padding-double margin-none">
                            <%
                                if (isIdentifierFirstLogin(inputType)) {
                            %>
                            ...
                            %>
                            用户<%=AuthenticationEndpointUtil.i18n(resourceBundle, "login")%>
                            <%
                                }
                            %>
                            
                        </h2>
						<div class="cont_title_box_bottom">欢迎使用统一身份平台</div>
                    </div>
                                   ...
                                   title="<%=AuthenticationEndpointUtil.i18n(resourceBundle,"sign.in.with")%>
                                    ...
                                    <div id="popover-content" class="hide">
                                        <form class="form-inline">
                                            <div class="form-group">
                                                IS<input id="domainName" class="form-control" type="text"
                                                       placeholder="<%=AuthenticationEndpointUtil.i18n(resourceBundle,
                                                       "domain.name")%>">
                                            </div>
                                            IS<input type="button" class="btn btn-primary go-btn"
