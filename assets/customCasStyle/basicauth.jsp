...
<form action="<%=loginFormActionURL%>" method="post" id="loginForm">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <label for="username" class="username_icon"><!--<%=AuthenticationEndpointUtil.i18n(resourceBundle, "username")%>--></label>
        <input id="username" name="username" type="text" class="form-control form-control-input" tabindex="0" placeholder="" required>
    </div>
    <% } else {%>
        <input id="username" name="username" type="hidden" value="<%=username%>">
    <% }%>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <label for="password" class="password_icon"><!--<%=AuthenticationEndpointUtil.i18n(resourceBundle, "password")%>--></label>
        <input id="password" name="password" type="password" class="form-control form-control-password" placeholder="" autocomplete="off">
    </div>
    <%
        if (reCaptchaEnabled) {
    %>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <div class="form-actions">
            <button
                    class="wr-btn red-btn red-bg col-xs-12 col-md-12 col-lg-12 uppercase font-extra-large margin-bottom-double"
