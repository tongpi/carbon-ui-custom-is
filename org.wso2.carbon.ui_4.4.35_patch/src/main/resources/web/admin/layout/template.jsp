...
%>
<link href="../admin/jsp/registry_styles_ajaxprocessor.jsp"
...
<body>
	...
	<script src="../yui/build/animation/animation-min.js"
		type="text/javascript"></script>
	...
	<script src="../yui/build/selector/selector-min.js"
		type="text/javascript"></script>
		...
		<tr>
			...
			<td id="menu-panel" valign="top">
				<table id="menu-table" border="0" cellspacing="0">
					...
					<tr>
						<td><img src="../admin/images/1px.gif" width="225px"
							height="1px" /></td>
					</tr>
				</table>
			</td>
			<td id="middle-content">
				<table id="content-table" border="0" cellspacing="0">
					<tr>
						<td id="page-header-links"><tiles:insertAttribute
								name="breadcrumb" /></td>
					</tr>
					<tr>
						<td id="body"><img src="../admin/images/1px.gif"
							width="735px" height="1px" /> <tiles:insertAttribute name="body" />
						</td>
					</tr>
				</table>
			</td>
